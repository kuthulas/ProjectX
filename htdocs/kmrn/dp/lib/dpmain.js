...
var allows = ["ProviderReseller","ResellerCustomer","CustomerDivision","DivisionLocation"];
var divsize = ((Math.random()*100) + 50).toFixed();
     ...
     var posy = (Math.random() * (500 - divsize)).toFixed();
			...
			d3.innerHTML = "<input class=\"transpropbox\" onclick=\"this.focus();this.select();\" id=\"name\" value=></input><br /><br /><input class=\"propbox\" onclick=\"this.focus();this.select();\" id=\"pipa\" value=></input><br /><br /><input class=\"propbox\" onclick=\"this.focus();this.select();\" id=\"user\" value=></input><br /><br /><input class=\"propbox\" onclick=\"this.focus();this.select();\" id=\"pass\" value=></input><br /><br /><a href=\"#\" id=\"submitme\" >Submit</a>"; 
			d2.appendChild(d3);
			}
